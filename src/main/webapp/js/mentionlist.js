$(document)
		.ready(
				function() {
					...
					function t(a) {
						var c = "/user/MentionListAjaxPage.action?pageNo=" + a
								+ "&userId=" + f + "&selectTime=" + d
					...
					var m = function(c) {
						...
						$
								.ajax({
									url : "/user/getMentionListAjaxPageResultCount.action?pageNo="
											+ u
											+ "&selectTime="
											+ a
											+ "&userId=" + f,
