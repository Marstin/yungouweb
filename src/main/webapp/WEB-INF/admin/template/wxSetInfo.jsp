...
<table width="100%" class="lr10">
  <tbody>
	<tr>
		<td width="200" align="right" style="padding-right:5px;">开启微信登录：</td>
		<td>
	...
	<tr>
		<td align="right" style="padding-right:5px;">微信公众号appid：</td>
		<td><input name="sysConfigure.weixinAppId" value="${sysConfigure.weixinAppId }"  class="input-text wid150" /></td>
	</tr>
	<tr>
		<td align="right" style="padding-right:5px;">微信公众号密钥：</td>
		<td><input name="sysConfigure.weixinAppSecret" value="${sysConfigure.weixinAppSecret }"  class="input-text wid300" /></td>
	</tr>
  <tr>
    <td align="right" style="padding-right:5px;">微信开放平台 appid：</td>
    <td><input type="text" value="${sysConfigure.wxAppID }" name="sysConfigure.wxAppID" class="input-text wid150" /></td>
  </tr>  
  <tr>
    <td align="right" style="padding-right:5px;">微信开放平台密钥：</td>
	...
	<tr>
    <td align="right" style="padding-right:5px;">开放平台回调地址：</td>
    <td>
